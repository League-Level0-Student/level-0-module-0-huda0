...
//    The ellipse command looks like this:      
 ...
 ellipse(250,235,150,150);
 ellipse(250,410,200,200);
//    The first 2 numbers speciy where to draw it. They are the x and y co-ordinates of the center of the ellipse.
