...
public class MadlibsOfTheAmazon {
	...
	string	JOptionPane.showInputDialog("Enter an adjective");
		// Get the player to enter a type of liquid
		JOptionPane.showInputDialog("Enter a type of liquid");
		// Get the player to enter a body part
		JOptionPane.showInputDialog("Enter a body part");
		...
		String story = 
		"Piranhas are more [fast] during the day, so cross the river at\n"  +
